...
- **Release under review:** `v0.5.5` (tag `v0.5.5`) — the read-only audit
...
- **Audited product-code commit:** `213cc04ebf1247a9fd861b4210c253c2317c658b`
  (tag `v0.5.5`). The hardening/pinning delta since the 0.5.0 baseline
