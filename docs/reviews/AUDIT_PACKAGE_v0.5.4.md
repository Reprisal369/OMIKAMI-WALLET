...
| **Release under review** | `v0.5.7` (tag `v0.5.7`) |
| **Audited product-code commit** | `79a22b5710d2935443381e1c0c2523447882e000` (tag `v0.5.7`) |
...
> The audited product code is the tree at tag `v0.5.7` (`79a22b5`). This package
...
cd OMIKAMI-WALLET
git checkout v0.5.7            # commit 79a22b5
corepack enable
...
## 7. Test evidence (verified for v0.5.7 / `79a22b5`)
...
| CI on `79a22b5` | **10/10 checks passed** (verify, e2e, SBOM+hash, OSV scan, secret scan, CodeQL, …) |
...
**Present and consistent (v0.5.7):**

- [x] Cover package — this document (`AUDIT_PACKAGE_v0.5.4.md`)
- [x] Scope & exclusions — `SECURITY_AUDIT_SCOPE.md` (→ v0.5.7 / `79a22b5`)
- [x] Reviewer handoff + outreach — `docs/reviews/REVIEWER_HANDOFF.md` (→ v0.5.7)
...
> - Release / tag to review: `v0.5.7` (commit `79a22b5`)
...
> https://github.com/Reprisal369/OMIKAMI-WALLET (tag `v0.5.7`). Would you be open
> to a short review? — Reprisal

---

*Prepared for external review. No product code was changed to assemble this
package; it documents the tree at tag `v0.5.7` (`79a22b5`).*
