...
2. Release / tag: **`v0.5.4`** (read-only audit candidate: internal pre-audit
   hardening + updated dependencies + pinned RPC egress).
3. Audited product-code commit: `073253cdd8dcd87e298cf95461925ab2e1c81f83`
   (tag `v0.5.4`).
