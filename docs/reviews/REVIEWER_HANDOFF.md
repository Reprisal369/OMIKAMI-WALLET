...
2. Release / tag: **`v0.5.5`** (read-only audit candidate: internal pre-audit
   hardening + updated dependencies + pinned RPC egress).
3. Audited product-code commit: `213cc04ebf1247a9fd861b4210c253c2317c658b`
   (tag `v0.5.5`).
