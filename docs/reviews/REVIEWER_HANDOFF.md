...
2. Release / tag: **`v0.5.2`** (read-only audit candidate: internal pre-audit
   hardening + updated dependencies + pinned RPC egress).
3. Audited product-code commit: `7f12132ef4197aa189bbc1e0931151a051132a97`
   (tag `v0.5.2`).
