...
> **Update:** the current release to review is **`v0.5.5`** (tag `v0.5.5`, commit
> `213cc04`). Since the 0.5.0 baseline this adds: the internal pre-audit hardening
...
> apply. Reproduce at tag `v0.5.5` for the latest code.
