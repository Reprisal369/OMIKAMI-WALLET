...
> **Update:** the current release to review is **`v0.5.7`** (tag `v0.5.7`, commit
> `79a22b5`). Since the 0.5.0 baseline this adds: the internal pre-audit hardening
...
> apply. Reproduce at tag `v0.5.7` for the latest code.
