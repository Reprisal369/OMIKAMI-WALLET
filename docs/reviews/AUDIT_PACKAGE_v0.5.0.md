...
> **Update:** the current release to review is **`v0.5.6`** (tag `v0.5.6`, commit
> `a7601cf`). Since the 0.5.0 baseline this adds: the internal pre-audit hardening
...
> apply. Reproduce at tag `v0.5.6` for the latest code.
